...
If no task path provided, look for:
- Recent task folder in `docs/tasks/`
- Active task mentioned in conversation

If no task context found, ask the user which task to research for.
