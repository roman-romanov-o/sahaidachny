...
- **Read**: Read task artifacts to understand current state
- **Edit**: Update existing files with progress markers
- **Glob**: Find task artifact files
- **Grep**: Search for status markers or criteria
